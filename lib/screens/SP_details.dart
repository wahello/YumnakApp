...
class SP_details extends StatefulWidget {
  @override
  _SP_detailsState createState() => _SP_detailsState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[IconButton(icon: Icon(Icons.home),onPressed: (){ Navigator.push(context, new MaterialPageRoute(builder: (context) => HomePage()));},)],
      ),
      body: ListView(
        children: <Widget>[
          Container(
